...
data1 = loadtxt("data_chip_backward_mirror_hard_sheet.txt")
...
x_filtered = df[["x"]].apply(savgol_filter,  window_length=10, polyorder=1)
x_filtered1 = df1[["x"]].apply(savgol_filter,  window_length=8, polyorder=1)
#df1 = pd.DataFrame(dict(x=data1))
